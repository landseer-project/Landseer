...
WORKER_CACHE_DIR="${WORKER_CACHE_DIR:-/data/landseer/cache}"
WORKER_WORKSPACE="${WORKER_WORKSPACE:-/data/landseer/worker}"
WORKER_DATA_PATH="${WORKER_DATA_PATH:-/data/landseer/landseer_old_data/data/celeba/clean}"
