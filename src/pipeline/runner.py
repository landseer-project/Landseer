...
class PipelineContext:
    def __init__(self, Stager):
        ...
        self.dataset_manager = Stager.dataset_manager
        self.combinations = self.make_combinations()

        self.pre_output_dir = None
        self.post_output_dir = None
        self.in_output_dir = None
