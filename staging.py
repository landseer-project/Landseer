...
class Stager:
    ...
    def __init__(self, config_path: str, attack_config_path: str=None):
        ...
        self.attacks = self._validate_and_load_attack_config()
    ...
    def _setup_logger(self):
        ...
        log_file_id = f"pipeline_{self.pipeline_id}_{timestamp}"
    ...
    def store_results(self, combination: str, dataset_name: str, dataset_dir: str, final_model_path: str, final_acc: float):
        ...
        results_file = os.path.join(results_dir, "pipeline_{pipeline_id}.csv")
