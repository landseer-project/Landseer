...
class DefensePipeline:
    ...
    def run(self):
        ...
        if not os.path.exists(baseline_model_path):
            ...
            baseline_acc = self.model_evaluator.train_baseline_model(final_dataset_path, baseline_model_path)
        else:
            logger.info("Using existing baseline model for comparison...")
            baseline_acc = self.model_evaluator.evaluate_model(baseline_model_path, final_dataset_path)
